...
async def filter(client, message):
    ...
    if 2 < len(message.text) < 100:    
        ...
        if files:
            ...
            await client.send_sticker(chat_id=message.from_user.id, sticker='CAACAgUAAxkBAALZQWGdDvOr1t_3dJv9VCwEQVAGFpWbAAJnBAACgRfoVM3Vigg9-kmUIgQ')
            return
        ...
        if len(btn) > 10: 
            ...
            if poster:
                await message.reply_photo(photo=poster, caption=f"<b>🗂️ Title: {search} ‌‌‌‌‎ ­  ­  ­  ­  ­  </b><\n><b>⭐ Rating: <\b><\n><b>🎭 Genre:<\b>", reply_markup=InlineKeyboardMarkup(buttons))
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            await query.message.edit(text="<b>Language : <code>Python3</code>\nLibrary : <a href='https://docs.pyrogram.org/'>Pyrogram asyncio</a>\nSource Code : <a href='https://github.com/chauhaniic/Media-Search-bot'>Click here</a></b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
        ...
        await query.answer("isn't a little fun👀",show_alert=True)
